...
const labels: Record<PickupStatus, string> = { AVAILABLE: 'Waiting for a partner', RESERVED: 'Reserved', IN_TRANSIT: 'Collector in transit', AWAITING_SCHOOL_CONFIRMATION: 'Confirm collection', COLLECTED: 'Collected', CANCELLED: 'Cancelled', EXPIRED: 'Expired' };
const steps: PickupStatus[] = ['AVAILABLE', 'RESERVED', 'IN_TRANSIT', 'AWAITING_SCHOOL_CONFIRMATION', 'COLLECTED'];
